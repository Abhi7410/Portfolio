...
import Sprinklr from "./Descriptions/Sprinklr";
import ISB from "./Descriptions/ISB";
import AnutaNetworks from "./Descriptions/AnutaNetworks";
import ProductLabs from "./Descriptions/ProductLabs";
import MarkovML from "./Descriptions/MarkovML";
...
export default function WhereIHaveWorked() {
  ...
  const [DescriptionJob, setDescriptionJob] = React.useState("Sprinklr");
  return (
