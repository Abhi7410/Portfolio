...
export default function MyName(props: { finishedLoading: boolean }) {
  ...
  return (
    ...
    >
      ...
      >
        I&apos;m a <span className="text-AAsecondary">web developer and ML enthusiast</span>, I possess strong problem-solving skills and
        specialize in crafting exceptional <br className="2xl:block hidden" />
        digital experiences. My current area of focus is in the <span className="text-AAsecondary">software development and NLP</span>,
        where I actively engage in developing <br className="2xl:block hidden"/>
        and designing immersive <span className="text-AAsecondary">applications</span>. This include working with different datasets and
        using <span className="text-AAsecondary">machine learning</span> to extract useful information from them and creating  
        <span className="text-AAsecondary"> web applications</span> to display the results. I am also interested in <span className="text-AAsecondary">full-stack development</span>.
