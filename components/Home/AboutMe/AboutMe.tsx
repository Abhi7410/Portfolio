...
export default function AboutMe(props) {
  const technologies = [
    ["React.js", "JavaScript (ES6+)", "Tailwind CSS", "Astro", "Express.js"],
    ["JAVA", "C++/C", "Python", "Node.js", "TypeScript"],
          ...
          <div className="w-full md:w-7/12 space-y-4 sm:text-base text-sm ">
            <div className="font-Header ">
              <span className="text-gray-400 ">
                Hello! My name is Abhishek Sharma, and I am an undergraduate student at International Insitute of Information Technology, Hyderabad. 
                I am a passionate developer, a tech enthusiast, and a ML enthusiast. I love to learn new things and explore new technologies.
                I am a quick learner and a team player. I am always ready to learn new things and explore new technologies.
              </span>
            </div>
            <div className="font-Header ">
              <span className="text-gray-400 ">
                I am pursuing my engineering degree in Computer Science. I have worked on various projects in the field of Web Development, Machine Learning, and NLP.
                I enjoyed working in teams and collaborating with people. I have done internships in the field of Web Development and Machine Learning in the past.
                {/* In the realm of{" "} */}
